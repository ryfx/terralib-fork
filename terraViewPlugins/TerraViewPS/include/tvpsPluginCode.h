...
"tvps",	///< The plugin's name.
"FUNCATE",	///< The plugin's vendor.
"TerraView Política Social",	///< The plugin's general description.
PLUGINPARAMETERS_VERSION,	///< The expected plugin parameters version.
"www.funcate.org.br",	///< The plugin vendor's homepage.
"geodesenv@funcate.org,br",	///< The plugin vendor's email address.
