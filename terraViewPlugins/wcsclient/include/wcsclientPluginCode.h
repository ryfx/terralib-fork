...
"WCS client",	///< The plugin's name.
"FUNCATE",	///< The plugin's vendor.
"A TerraView Plugin to WCS Access",	///< The plugin's general description.
PLUGINPARAMETERS_VERSION,	///< The expected plugin parameters version.
"http://www.terralib.org/terraview/tvplugins/wcs/",	///< The plugin vendor's homepage.
"funcate@funcate.org.br",	///< The plugin vendor's email address.
