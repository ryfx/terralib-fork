...
"wfsclient",	///< The plugin's name.
"Frederico A. Bede",	///< The plugin's vendor.
"Creates themes based on WFS services.",	///< The plugin's general description.
PLUGINPARAMETERS_VERSION,	///< The expected plugin parameters version.
"funcate@org.br",	///< The plugin vendor's homepage.
"frederico.bede@funcate.org.br",	///< The plugin vendor's email address.
