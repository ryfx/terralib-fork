...
"FileTheme",	///< The plugin's name.
"INPE/DPI",	///< The plugin's vendor.
"A TerraView plugin to geographical file access",	///< The plugin's general description.
PLUGINPARAMETERS_VERSION,	///< The expected plugin parameters version.
"http://www.terralib.org",	///< The plugin vendor's homepage.
"lubia@dpi.inpe.br",	///< The plugin vendor's email address.
