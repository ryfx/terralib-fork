...
"oracleSpatialAdapter",	///< The plugin's name.
"INPE/DPI",	///< The plugin's vendor.
"A TerraView plugin to access oracle spatial data",	///< The plugin's general description.
PLUGINPARAMETERS_VERSION,	///< The expected plugin parameters version.
"http://dpi.inpe.br/terralib",	///< The plugin vendor's homepage.
"mario@dpi.inpe.br",	///< The plugin vendor's email address.
