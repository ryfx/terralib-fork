...
2,	///< The minor version (e.g. 0.10).
true,	///< Does this plugin show its arguments to the public?
"geodma",	///< The plugin's name.
"Thales Sehn Korting",	///< The plugin's vendor.
"Geographic Data Mining Analyst",	///< The plugin's general description.
PLUGINPARAMETERS_VERSION,	///< The expected plugin parameters version.
"http://geodma.sf.met/",	///< The plugin vendor's homepage.
"tkorting@dpi.inpe.br",	///< The plugin vendor's email address.
