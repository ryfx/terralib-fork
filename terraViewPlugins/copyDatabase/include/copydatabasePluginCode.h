...
"copyDatabase",	///< The plugin's name.
"FUNCATE",	///< The plugin's vendor.
"A TerraView plugin to copy databases",	///< The plugin's general description.
PLUGINPARAMETERS_VERSION,	///< The expected plugin parameters version.
"http://www.funcate.org.br",	///< The plugin vendor's homepage.
"mario@funcate.org.br",	///< The plugin vendor's email address.
