...
///Funcao principal da interface. Executa o Metodo de Diggle quando o botão "OK" é clicado e apresenta resultados finais na interface.
...
{	
	...
	//Pega do banco os atributos e geometrias que serão utilizados no método de Diggle
	vector<string> attrs;
